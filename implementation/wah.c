...
void setWahPedal(Int16 adcVal) {
	...
	// sin_coeff is rounded to 5 (from 4.669) which means
	// error in Fc calculation, factor = 4.669/5 = 0.9337
	// thus, Fc is calculated in range factor*350 to factor*2250
	// meaning 326 to 2100 Hz
