...
xline(0.53, '--', 'Start regression 0.53s', 'Color', 'k', 'LabelVerticalAlignment', 'bottom');
xline(1.72, '--', 'End regression 1.72s', 'Color', 'k', 'LabelVerticalAlignment', 'middle');
...
filePath = fullfile(saveFolder, sprintf('%s.png','reverb_schroeder_rt60_4s'));
exportgraphics(fig4s(1), filePath, 'Resolution', 300);